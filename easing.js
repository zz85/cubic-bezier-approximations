...
var BSEasing = {
	QuadIn: [ 0.5, 0, 0.9, 0.8 ] ,
	QuadOut: [ 0.1, 0.2, 0.5, 1 ] ,
	QuadInOut: [ 0.5, 0.1, 0.5, 0.9 ] ,
	CubicIn: [ 0.4, 0, 0.7, 0.1 ] ,
	CubicOut: [ 0.3, 0.9, 0.6, 1 ] ,
	CubicInOut: [ 0.7, 0, 0.3, 1 ] ,
	QuartIn: [ 0.6, 0, 0.7, 0 ] ,
	QuartOut: [ 0.3, 1, 0.4, 1 ] ,
	QuartInOut: [ 0.8, 0, 0.2, 1 ] ,
	QuintIn: [ 0.6, 0, 0.8, 0 ] ,
	QuintOut: [ 0.2, 1, 0.4, 1 ] ,
	QuintInOut: [ 0.9, 0, 0.1, 1 ] ,
	SineIn: [ 0.1, 0, 0.4, 0 ] ,
	SineOut: [ 0.6, 1, 0.9, 1 ] ,
	SineInOut: [ 0.4, 0, 0.6, 1 ] ,
	ExpoIn: [ 0.6, 0, 0.9, 0 ] ,
	ExpoOut: [ 0.1, 1, 0.4, 1 ] ,
	ExpoInOut: [ 0.9, 0, 0.1, 1 ] ,
	CircIn: [ 0.5, 0, 1, 0.4 ] ,
	CircOut: [ 0, 0.6, 0.5, 1 ] ,
	CircInOut: [ 0.8, 0.1, 0.2, 0.9 ] ,
};
